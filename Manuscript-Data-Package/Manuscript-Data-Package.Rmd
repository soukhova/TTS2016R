...
```{r tts-workers-jobs-plot, fig.cap="\\label{fig:tts-workers-jobs-plot}Number of workers (left) and jobs (right) in each TAZ in the GGH area as specified in the 2016 TTS.", fig.width=8, fig.height=5}
...
```{r plot-tt-ttpertrip, fig.cap="\\label{fig:plot-tt-ttpertrip}Estimated total worker travel time (left) and average worker travel time (right) for each TAZ in the GGH.", fig.width=8, fig.height=5, message=FALSE}
...
```{r TLD-Gamma-plot, fig.cap="\\label{fig:TLD-Gamma-plot}Empirical TTS 2016 home-based car trip length distribution (black) and calibrated gamma distribution impedance function (red) with associated Q-Q and P-P plots", out.width="75%", fig.align='center'}
